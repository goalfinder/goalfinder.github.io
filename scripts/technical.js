...
document.addEventListener("DOMContentLoaded", async () => {
	...
	runTests(`${baseUrl}/content/content-structures/technical-content-structure-en.json`, `${baseUrl}/content/content-structures/technical-content-structure-de.json`);
});
