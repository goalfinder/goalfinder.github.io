...
## Inhaltsverzeichnis
### Aufsetzen
- ^[GoalFinder kennenlernen](content/user/en/getting-to-know.md)
- ^[Montage](content/user/en/mounting.md)
- ^[Web-App](content/user/en/webapp.md)
- ^[Spiele](content/user/en/games.md)

### Verwaltung
- ^[Updates](content/user/de/update.md)

### Verwendung
- ^[Häufig gestellte Fragen](content/user/en/faq.md)
