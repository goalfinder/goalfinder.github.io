# Assembly
## 1. Assemble the PCB
Follow the provided schematics and source files to assemble the PCB. The ToF sensor and amplifier should be mounted directly onto the PCB.
...
#ih Note
#ib We recommend cutting off the top section of the Micro USB breakout board to prevent damage to the microcontroller's USB port.
...
Use a soldering iron to melt the plastic and insert the threaded inserts into the main bracket. This helps secure the inserts in place.
...
Clip the SW420 shake sensor into the inner bracket. It should fit securely in place.
...
## 6. Connect the Main Bracket to the Audio Plate
Screw the bottom plate (with the audio driver attached) to the inner bracket.
...
If this step has been reached, the GoalFinder assembly is complete. If any issues were encountered or suggestions for improvement are available, please contact us.
