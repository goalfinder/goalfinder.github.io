...
Connect the shake sensor using the 3-pin JST connector and connect speaker to the amplifier. Place the PCB onto the main bracket—the through holes should allow the PCB to snap into place without additional fasteners.
