...
Visit the [GoalFinder Repository]() to clone the project and upload the firmware using PlatformIO. Run `pio run -t upload` and `pio run -t uploadfs` from the `client/embedded/` directory.
