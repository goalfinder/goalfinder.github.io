...
The outer housing is made up of six plates. Two of these plates can be replaced with mounting variants, depending on your installation needs. The plates shown are cut from acrylic glass, but they can also be easily 3D printed.
...
#### MAX98357A
Amplifier for connecting to the speaker.
...
![Speaker](assets/img/assembly/steps/high_res/GF_assembly_28.jpg)(510x614)
[Product Link](https://www.amazon.de/-/en/HUAREW-JST-PH2-0-Interface-Motherboard-Electronic/dp/B0CRNZYW1R/ref=sr_1_6)

### Other Parts
#### USB-C Port
Port for external USB-C connection on the side panel.
![USB-C Port](assets/img/assembly/steps/high_res/GF_assembly_06.jpg)(510x614)
